        ...
        <header className={`border-b ${isDarkTheme ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} px-4 py-3 transition-colors duration-200`}>
            ...
            <div className="hidden lg:flex items-center justify-between max-w-full">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {/* Popular Languages Quick Access - Only show on very large screens */}
                    <nav className="hidden 2xl:flex items-center gap-1 ml-4">
                        {['json', 'javascript', 'python', 'java', 'typescript'].map((lang) => {
                            ...
                            return (
                                <button
                                    ...
                                    title={`${displayName} Code Diff Tool`}
                                >
                                    {displayName}
                                </button>
                            );
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        >
                            {supportedLanguages.map(lang => (
                                <option key={lang} value={lang} className={isDarkTheme ? 'bg-gray-700' : 'bg-white'}>
